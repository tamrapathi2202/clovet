    ...
    <div className="min-h-screen bg-slate-50 flex flex-col">
      <header className="bg-white border-b border-slate-200 sticky top-0 z-50" style={{ borderColor: '#2d5016' }}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-4 flex items-center justify-between" style={{ backgroundColor: 'rgb(248 242 237)' }}>
          ...
          <h1 className="text-2xl font-bold text-slate-900" style={{ fontFamily: 'Georgia, serif', color: 'rgb(45 80 22)', fontSize: '2.5rem', fontFamily: 'var(--font-warbler)' }}>
            Clovet
          </h1>
          ...
          >
            <User className="w-6 h-6 text-slate-700"  style={{ color: 'rgb(242, 109, 22)' }} />
          </button>
        </div>
      </header>

      <main className="flex-1 pb-20" style={{ backgroundColor: 'rgba(255, 251, 247, 1)' }}>
        {children}
      </main>

      <nav className="fixed bottom-0 left-0 right-0 bg-white border-t border-slate-200">
  <div className="max-w-7xl mx-auto px-4 flex items-center justify-around py-3" style={{ backgroundColor: 'rgb(248, 242, 237)', textcolor: 'rgb(45, 80, 22)', fontFamily: 'var(--font-warbler)' }}>
    <button
      onClick={() => onNavigate('home')}
      className="flex flex-col items-center gap-1 px-4 py-2 rounded-lg transition"
    >
      <Home className="w-6 h-6" style={{ color: 'rgb(242, 109, 22)' }} />
    ...
    <button
      ...
      className="flex flex-col items-center gap-1 px-4 py-2 rounded-lg transition"
    >
      <Search className="w-6 h-6" style={{ color: 'rgb(242, 109, 22)' }} />
    ...
    >
      <Heart className="w-6 h-6" style={{ color: 'rgb(242, 109, 22)' }} />
      <span className="text-xs font-medium" style={{ color: 'rgb(45, 80, 22)' }}>Favorites</span>
          ...
          >
            <ShoppingBag className="w-6 h-6" style={{ color: 'rgb(242, 109, 22)' }} />
