...
export default function VirtualTryOnView({ onBack, favorites }: VirtualTryOnProps) {
  ...
  const generateVirtualTryOn = async () => {
    ...
    try {
      ...
      // Use Gemini API for virtual try-on analysis
  ...
  const renderSelectClothes = () => (
    <div className="max-w-4xl mx-auto">
      <div className="text-center mb-8">
        ...
        <p className="text-slate-600">Choose up to 3 items from your favorites to create an outfit</p>
        <p className="text-sm text-slate-500 mt-2">{selectedItems.length}/3 items selected</p>
      </div>
